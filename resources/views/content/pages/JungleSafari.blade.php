...
@section('content')
    ...
    <div class="offcanvas offcanvas-end event-sidebar " tabindex="-1" id="addEventSidebar"
        ...
        <div class="offcanvas-header my-1">
            <h5 class="offcanvas-title" id="addEventSidebarLabel">Add Jungle Safari</h5>
            ...
            <form action="{{ url('/') }}/product" method="post" enctype="multipart/form-data">
                ...
                <div class="container">
                    <div class="mb-3 fv-plugins-icon-container">
                        <label class="form-label" for="fname">Safari Name</label>
                        <input type="text" class="form-control" name="name" id=" "
                            placeholder="enter safari name" value="">
                    ...
                    <div class="mb-3 fv-plugins-icon-container">
                        <label for="formFileMultiple" class="form-label">Upload Gallary</label>
                        <input class="form-control" type="file" name="image" id="formFileMultiple" required
                            class=" form-control" onchange="preview()" multiple>
                        <span class="text-danger">
                            @error('name')
                                {{ $message }}
                            @enderror
